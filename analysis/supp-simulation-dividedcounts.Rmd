---
title: "Simulation Study - Supplementary Results (Divided Counts & Strict Filtering)"
...
path.misc <- file.path('../misc/supp-simulation-dividedcounts.Rmd')
...
meth.null <- c("edgeR-scaled-F","edgeR-scaled-Simes","limma-scaled-F","limma-scaled-Simes","DRIMSeq-scaled")
```
...
```{r simulation_error,fig.width = 5,fig.height = 5}
dt.p <- 
...
```{r simulation_power5,fig.width = 7.5,fig.height = 5}
...
plot.power <- function(df.bar,df.txt,library,scenario,feature,legend = FALSE, base_size = bs,maxy = 4000,...){
  ...
  gap <- 0.05*max(df.txt$TP + df.txt$FP)
...
```{r simulation_power1,fig.width = 7.5,fig.height = 5}
...
fig.power.1pct.a <- plot.power(df.bar = x.melt.1pct,df.txt = dt.power.1pct,
                          library = '3 samples per group',
                          scenario = 'Unequal library sizes',
                          feature = 'Gene',
                          y = 'Genes with FDR < 0.01')

fig.power.1pct.b <- plot.power(df.bar = x.melt.1pct,df.txt = dt.power.1pct,
                          library = '5 samples per group',
                          scenario = 'Unequal library sizes',
                          feature = 'Gene',
                          y = 'Genes with FDR < 0.01')

fig.power.1pct.c <- plot.power(df.bar = x.melt.1pct,df.txt = dt.power.1pct,
                          library = '10 samples per group',
                          scenario = 'Unequal library sizes',
                          feature = 'Gene',
                          y = 'Genes with FDR < 0.01')

fig.power.1pct.tx.d <- plot.power(df.bar = x.melt.1pct,df.txt = dt.power.1pct,
                             library = '3 samples per group',
                             scenario = 'Unequal library sizes',
                             feature = 'Transcript',
                             y = 'Transcripts with FDR < 0.01',maxy = 9000)

fig.power.1pct.tx.e <- plot.power(df.bar = x.melt.1pct,df.txt = dt.power.1pct,
                             library = '5 samples per group',
                             scenario = 'Unequal library sizes',
                             feature = 'Transcript',
                             y = 'Transcripts with FDR < 0.01',maxy = 9000)

fig.power.1pct.tx.f <- plot.power(df.bar = x.melt.1pct,df.txt = dt.power.1pct,
                             library = '10 samples per group',
                             scenario = 'Unequal library sizes',
                             feature = 'Transcript',
                             y = 'Transcripts with FDR < 0.01',maxy = 9000)

fig.power.1pct <- wrap_plots(A = fig.power.1pct.a,
                        B = fig.power.1pct.b,
                        C = fig.power.1pct.c,
                        D = fig.power.1pct.tx.d,
                        E = fig.power.1pct.tx.e,
                        `F` = fig.power.1pct.tx.f,
                        design = c(area(1,1),area(1,2),area(1,3),
                                   area(2,1),area(2,2),area(2,3))) +
  plot_annotation(tag_levels = 'a',theme = theme(plot.tag = element_text(size = bs)))
...
ggsave(plot = fig.phist.un,
       filename = file.path(path.misc,'SuppFigure-DividedCounts-Pval-Gene-Unbalanced.pdf'),
       device = 'pdf',width = 5,height = 5,units = 'in')
ggsave(plot = fig.phist.tx.un,
       filename = file.path(path.misc,'SuppFigure-DividedCounts-Pval-Transcript-Unbalanced.pdf'),
       device = 'pdf',width = 5,height = 5,units = 'in')
ggsave(plot = fig.t1e,
       filename = file.path(path.misc,'SuppFigure-DividedCounts-ErrorRate.pdf'),
       device = 'pdf',width = 7.5,height = 5,units = 'in')
ggsave(plot = fig.power,
       filename = file.path(path.misc,'SuppFigure-DividedCounts-Power.pdf'),
       device = 'pdf',width = 7.5,height = 5,units = 'in')
ggsave(plot = fig.power.1pct,
       filename = file.path(path.misc,'SuppFigure-DividedCounts-Power-1Pct.pdf'),
       device = 'pdf',width = 7.5,height = 5,units = 'in')
ggsave(plot = fig.fdr,
       filename = file.path(path.misc,'SuppFigure-DividedCounts-FDR.pdf'),
       device = 'pdf',width = 7.5,height = 5,units = 'in')
ggsave(plot = fig.roc,
       filename = file.path(path.misc,'SuppFigure-DividedCounts-ROC.pdf'),
       device = 'pdf',width = 7.5,height = 5,units = 'in')
```
