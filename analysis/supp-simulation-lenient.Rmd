---
title: "Simulation Study - Supplementary Results (Lenient Filtering)"
...
path.misc <- file.path('../misc/supp-simulation-lenient.Rmd')
dir.create(path.misc,recursive = TRUE,showWarnings = FALSE)

# Gene-level stats
path.metrics.lenient <-
  list.files('../output/simulation-lenient-no-trend/summary','metrics.gene.tsv.gz',recursive = TRUE,full.names = TRUE)
path.metrics <-
...
path.metrics.tx.lenient <-
  list.files('../output/simulation-lenient-no-trend/summary','metrics.transcript.tsv.gz',recursive = TRUE,full.names = TRUE)
path.metrics.tx <-
